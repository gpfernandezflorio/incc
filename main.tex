...
\begin{frame}{}{}
  \begin{itemize}
  \item {\textbf{Asociación en la memoria:}  relación que percibimos entre palabras, 		objetos, lugares, emociones. En este caso, imágenes, precisamente logos.
} %\pause
  \item {\textbf{Aprendizaje incidental:} información captada y almacenada de forma involuntaria como consecuencia de la simple exposición a situaciones en las que intervienen esos contenidos
}
  \begin{itemize}
  \item {\textbf{Memoria implicita:} recuerdo no intencional de algo como consecuencia de la presentaciön de una clave o estimulo.
}%\pause
  \end{itemize}
  \item {\textbf{Aprendizaje intencional:}  tiene lugar cuando prestamos atención a la información y la estudiamos con la intención de recordarla posteriormente
}%\pause
  \begin{itemize}
  \item {\textbf{Memoria explicita:} recuerdo voluntario y consciente que ocurre cuando nos proponemos recuperar intencionalmente algún contenido de nuestra memoria
}
  \end{itemize}
...
\begin{frame}{}{}
  ...
  \item {
Asociaciones como base en la formación de conocimientos: importancia en psicología!
la asociación como concepto clave para "explicar" el funcionamiento de la mente y del conocimiento humano esta idea la toma la psicología de la corriente empirista (todo conocimiento procede de la experiencia)
  }%\pause 
  \item {\textbf{Existen principios de contiguidad, semejanza y contraste aunque actualmente se considera que los conocimientos contenidos en nuestra memoria constituyen nodos de una red -red semantica- (se puede medir distancias semanticas entre nodos midiendo tiempos de reacción)  
}  
}
...
La prueba de Bartlett se utiliza para probar la hipótesis nula H0 (todas las varianzas de una población k son iguales), frente a la hipótesis alternativa de que al menos dos son diferentes.
...
Se trata de una prueba bilateral para la hipótesis nula de que 2 muestras independientes tienen idénticos valores medios. Esta prueba asume que las poblaciones tienen varianzas iguales.
